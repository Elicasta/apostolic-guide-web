...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Apostolic Guide | Know What You Believe and Why", description: "Search Scripture, follow connected passages, and understand Apostolic doctrine from the biblical text.", type: "website", siteName: "Apostolic Guide", url: websiteUrl, locale: "en_US", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Apostolic Guide — Scripture, doctrine, and biblical answers" }] },
  twitter: { card: "summary_large_image", title: "Apostolic Guide | Know What You Believe and Why", description: "Search Scripture, follow connected passages, and understand Apostolic doctrine from the biblical text.", images: ["/opengraph-image"] },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organizationJsonLd) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(websiteJsonLd) }} /><a className="skip-link" href="#main-content">Skip to content</a><SiteHeader /><GlobalBackNav /><main id="main-content">{children}</main><FooterConnect /><SiteFooter /><SiteBehavior /><Suspense fallback={null}><ReadingProgress /><EmailCapture /><ProductAnalytics /></Suspense><Analytics /><SpeedInsights /></body></html>;
}
