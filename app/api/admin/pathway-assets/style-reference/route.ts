...
export async function POST(request: Request) {
  ...
  const asset = await service.from("studio_pathway_assets").select("id,storage_bucket,storage_path,public_url,asset_type").eq("id", parsed.data.assetId).maybeSingle();
